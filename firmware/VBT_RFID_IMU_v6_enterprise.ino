/*
  VBT_RFID_IMU_v6_enterprise.ino
  ESP32-S3 + QMI8658 IMU + TFT_eSPI Display + 3 Buttons
  + WiFi (WPA2-Enterprise) + Button-based Player/Exercise Selection + HTTP Upload

  Same as v6 but uses WPA2-Enterprise (802.1X) WiFi for school/facility
  networks that require username + password login (PEAP/MSCHAPv2).
  Also uses GPIO10 for Yellow button instead of GPIO12.
...
#include <esp_wifi.h>
#include <esp_wpa2.h>          // WPA2-Enterprise (Arduino core 2.x / ESP-IDF 4.x)

// ══════════════════════════════════════════════════════════════════════
//  CONFIGURATION — edit these for your deployment
// ══════════════════════════════════════════════════════════════════════
#define WIFI_SSID       "ACSD-Staff"
#define WIFI_USER       "rmckenzie"
#define WIFI_PASS       "Aiken2526!"
...
bool connectWiFi() {
  ...
  WiFi.begin(WIFI_SSID);  // no password arg — EAP handles auth
